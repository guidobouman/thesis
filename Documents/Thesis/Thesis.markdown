...
#### Gesture based input
Gesture based control seems to be a trend. Touch screens and the Apple touchpad allow for touch based gestures. Where devices like Kinect, Leap and Myo (more on these later) take a different approach. They track your movements and allow you to freely interact with an electronic device in 3D space. Usually freeing you from your desk or at least replacing (partial) functionality of the mouse. Natural gestures could be faster and less error prone than through the use of a mouse click.

"The Kinect is a motion sensing input device by Microsoft for the Xbox 360 video game console and Windows PCs." [Wikipedia][#Wikipedia_Kinect:2013] It has a camera that tracks your whole body and it movements. It's still quite rough, large movements are needed to trigger an action. The LEAP takes a different approach, Wikipedia [2013][#Wikipedia_Leap:2013] has a good description of the device: "The Leap Motion controller is a small USB peripheral device which is designed to be placed on a physical desktop, facing upward. Using two cameras and three infrared LEDs. It is designed to track fingers (or similar items such as a pen) which cross into the observed area." By limiting the area, the movements can be tracked on a much more granular level. Precise finger gestures make the LEAP very usable for interaction with applications that require precise control rather than large gestures. According to Thalmic Labs, the company behind the MYO, their product can be described with the following description: "The MYO is an armband that measures electrical activity in users' muscles giving them the ability to wirelessly control and interact with computers and other digital consumer products." [Thalmic Labs, 2013][#ThalmicLabs:2013]  This would take the LEAP's approach even a step further by removing the camera and tracking muscle tension on the lower arm. Which results in freeing the user from any location or direction based limitation.
...
The MYO is set to ship late 2013, early 2014. If it's able to deliver, it could change the way we control our devices. Completely freeing you from the direct proximity of your device, communicating gestural actions through bluetooth to the target device. Using it as a remote for about any electronic device in our home. This could be the phone in your pocket, computer in the next room or music setup in your closet. That is, if it's able to manage target selection well. In other words, the device should know what device you're targeting with every gesture. When you turn the volume of your music setup down, you don't want it to go back up when you try to answer an incoming phone call seconds later. [Thalmic Labs, 2013][#Thalmic:2013]
...
[#Wikipedia_Kinect:2013]: Wikipedia. (2013). Kinect. Retrieved from: http://en.wikipedia.org/wiki/Kinect
[#Wikipedia_Leap:2013]: Wikipedia. (2013). Leap Motion. Retrieved from: http://en.wikipedia.org/wiki/Leap_Motion
[#ThalmicLabs:2013]: Thalmic Labs. (2013). New Video Reveals MYO Armband's Leading Edge on Gesture Control Market. Retrieved from: http://finance.yahoo.com/news/video-reveals-myo-armbands-leading-131939421.html
